...
def PreActResNet18(args):
    return PreActResNet(PreActBlock, [2,2,2,2], n_classes=args.n_classes)


def PreActResNet34(args):
    return PreActResNet(PreActBlock, [3,4,6,3], n_classes=args.n_classes)


def PreActResNet50(args):
    return PreActResNet(PreActBottleneck, [3,4,6,3], n_classes=args.n_classes)


def PreActResNet101(args):
    return PreActResNet(PreActBottleneck, [3,4,23,3], n_classes=args.n_classes)


def PreActResNet152(args):
    return PreActResNet(PreActBottleneck, [3,8,36,3], n_classes=args.n_classes)
