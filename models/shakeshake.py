"""
Adapted from https://github.com/owruby/shake-shake_pytorch/tree/master/models
"""
...
__all__ = ['shakeResNeXt', 'shakeResNet']
...
def shakeResNet(args):
    return ShakeResNet(depth=args.depth, w_base=args.base_channels, label=args.n_classes)


def shakeResNeXt(args):
    return ShakeResNeXt(depth=args.depth, w_base=args.base_channels, cardinary=args.cardinality, label=args.n_classes)
