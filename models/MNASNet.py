...
def mnasnet0_5(args):
    model = MNASNet(alpha=0.5, num_classes=args.n_classes, dropout=args.drop_prob)
    return model


def mnasnet0_75(args):
    model = MNASNet(alpha=0.75, num_classes=args.n_classes, dropout=args.drop_prob)
    return model


def mnasnet1_0(args):
    model = MNASNet(alpha=1.0, num_classes=args.n_classes, dropout=args.drop_prob)
    return model


def mnasnet1_3(args):
    model = MNASNet(alpha=1.3, num_classes=args.n_classes, dropout=args.drop_prob)
    return model
